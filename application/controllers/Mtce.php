...
private $items_per_page = 10; // Yan added
    ...
    private function showit()
    {
        ...
        $fields = array(
            ...
            'fsize'  => form_label('Size') . form_dropdown('size', $this->app->priority(), $task->size),
            'fgroup'  => form_label('Group') . form_dropdown('group', $this->app->priority(), $task->group),
            'fstatus'  => form_label('Status') . form_dropdown('status', $this->app->priority(), $task->status),
